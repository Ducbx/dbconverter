...
// DBConverter.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CDBConverterApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CDBConverterApp construction

CDBConverterApp::CDBConverterApp()
{
...
// The one and only CDBConverterApp object

CDBConverterApp theApp;


// CDBConverterApp initialization

BOOL CDBConverterApp::InitInstance()
{
